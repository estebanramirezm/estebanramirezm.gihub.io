...
document.write('<img src="estebanramirezm.github.io/IntroToWebDev/final' + product.imagePath3 + '" class="product-thumb" alt="">');
document.write('<img src="estebanramirezm.github.io/IntroToWebDev/final' + product.imagePath4 + '" class="product-thumb" alt="">');
document.write('</div>');
document.write('</div>');
