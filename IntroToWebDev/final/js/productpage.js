...
document.write('<img src="IntroToWebDev/final' + product.imagePath + '" class="product-thumb" alt="">');
document.write('<img src="IntroToWebDev/final' + product.imagePath2 + '" class="product-thumb" alt="">');
document.write('<img src="IntroToWebDev/final' + product.imagePath3 + '" class="product-thumb" alt="">');
